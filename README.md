...
- Mais 1 espaço livre para os próximos sites.
...
1. Faça "localizar e substituir" de `SEU-DOMINIO.com.br` pelo seu domínio em **todos os arquivos** (index.html, case.html, robots.txt, sitemap.xml). O preview só aparece com o endereço completo (https://...).
